...
console.log('The Telegram bot will use local shim (seiService) if the plugin is not installed.');
console.log('To enable Eliza forwarding, set ELIZA_ENABLED=true in your .env and ensure @elizaos/plugin-sei is installed.');
